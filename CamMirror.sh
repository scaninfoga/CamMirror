#!/bin/bash
# CamMirror v1.5
# Powered by Rohan Nahak
# Credits goes to scaninfoga [github.com/scaninfoga/]

trap 'printf "\n";stop' 2

banner() {
clear
printf "Rohan Nahak Certified Ethical Hacker"

printf " \e[1;93m CamMirror Ver 5.1 \e[0m \n"
printf " \e[1;77m www.scaninfogaa.in | https://www.youtube.com/channel/UCl9W4KnQ0Yk8HQdxlcFP7Zg/featured \e[0m \n"
